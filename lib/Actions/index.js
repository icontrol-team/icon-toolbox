...
import {
    ...
    set_INS_config,
    getKeystore, iconTemplateMethod, arrayContains
...
const actions = {
    ...
    sign: () => (state, actions) => {
        ...
        // let method = getIdValue("methods");

        // let score_address = INS_SETTINGS[getNetworkInfo(state).network_name].score_address;

        // let ins_score_address = get_ins_score_address();
        // if (ins_score_address){
        //     json_rpc.params.to = ins_score_address;
        // }
        // switch (method){
        //     // case default:
        //     case "registerINS":
        //         json_rpc.params.value = "0x0";
        //         json_rpc.params.data.params._address = getKeystore().address;
        //         break;
        //     case "setInsServiceAdmin":
        //         json_rpc.params.value = "0x0";
        //         json_rpc.params.data.params._ins_service_admin = ""
        //         break;
        // }
    ...
    get_ins_address:  () => (state, actions) => {
        ...
        try {
            ...
            icx_utils.call_api_payload(payload_data, true).then(function(data) {
